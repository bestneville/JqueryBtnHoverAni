(function () {
    ...
    b.prototype = {
        ...
        drawArc: function (t, x, y, radius, startAngle, endAngle, globalAlpha, fillStyle) {
            t.ctx.beginPath();
            t.ctx.arc(x, y, radius, startAngle, endAngle);
            t.ctx.closePath();
            t.ctx.globalAlpha = globalAlpha;
            t.ctx.fillStyle = fillStyle;
            t.ctx.fill();
        },
        x1: function (t) {
            if (t.f) {
